    ...
    if (m_tweets != null) {
      for (Status tweet : m_tweets) {
        ...
        final TweetView tweetView = new TweetView(this, tweet, width, false, 
            Resources.HOVER_COLOR, Resources.HOVER_COLOR, Resources.HOVER_COLOR, m_nameClkHandler, m_handlerCallee,tweet.isRetweetedByMe(),tweet.getCurrentUserRetweetId(),tweet.isFavorited());
