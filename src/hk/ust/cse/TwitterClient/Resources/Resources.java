...
public class Resources {
  ...
  static {
    ...
    At_COLOR       = new Color(null, 0, 132,194);
    TWEET1_COLOR   = new Color(null, 170, 170, 170);
    ...
    DISCOVER_IMG     = Utils.loadImageFromLocal(Resources.class, "./discover.png");
    DISCOVER_HOVER_IMG = Utils.loadImageFromLocal(Resources.class, "./discover2.png");
    POST_IMG         = Utils.loadImageFromLocal(Resources.class, "./post.png");
    POST_HOVER_IMG   = Utils.loadImageFromLocal(Resources.class, "./post2.png");
    POST_BOX_IMG     = Utils.loadImageFromLocal(Resources.class, "./POST_BOX.png");
    POST_BOX_HOVER_IMG = Utils.loadImageFromLocal(Resources.class, "./POST_BOX2.png");
    POSTED_INFO_IMG  = Utils.loadImageFromLocal(Resources.class, "./POSTED.png");
  }
  ...
  public static final Color At_COLOR;
  public static final Color TWEET1_COLOR;
  ...
  public static final Image DISCOVER_IMG;
  public static final Image DISCOVER_HOVER_IMG;
  public static final Image PEOPLE_IMG;
  public static final Image PEOPLE_HOVER_IMG;
  public static final Image POST_IMG;
  public static final Image POST_HOVER_IMG;
  public static final Image POST_BOX_IMG;
  public static final Image POST_BOX_HOVER_IMG;
  public static final Image POSTED_INFO_IMG;
}
