...
public class ControlBar extends RowComposite {
  ...
  private void initialize(int width, int height, int initLeftMargin) {
    ...
    m_discover = new ControlBarItem(buttonFrame, "Discover",Resources.DISCOVER_IMG,Resources.DISCOVER_HOVER_IMG);
    m_discover.setLayoutData(new RowData(Resources.DISCOVER_IMG.getBounds().width,
    									 Resources.DISCOVER_IMG.getBounds().height));
    Utils.addClickListener(m_discover, m_btnClkHandler, m_handlerCallee);
  ...
  private ControlBarItem m_discover;
